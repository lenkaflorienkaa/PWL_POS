@extends('adminlte::auth.auth-page', ['auth type' => 'login'])
...
@section('auth_body')
    ...
    <form action="{{ url('proses_login') }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="{{ __('Username') }}" autofocus>
